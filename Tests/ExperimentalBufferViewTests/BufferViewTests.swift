...
final class BufferViewTests: XCTestCase {
  ...
  func testInitBitwiseCopyableElement() {
    ...
    XCTAssertNil(BufferView(unsafeBufferPointer: e, dependsOn: e))
    ...
    XCTAssertNil(BufferView<Int>(unsafeRawBufferPointer: v, dependsOn: v))
  }
  ...
  public func testIteratorBitwiseCopyable() {
    ...
    let buffer = BufferView<Int64>(unsafeBaseAddress: p+offset, count: count, dependsOn: p)
