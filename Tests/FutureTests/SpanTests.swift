...
//    )
  ...
  func testInitWithOrdinaryElement() {
    ...
    s.withUnsafeBufferPointer {
      var span = Span(_unsafeElements: $0, owner: s)
      XCTAssertEqual(span.count, capacity)

      span = Span(_unsafeStart: $0.baseAddress!, count: $0.count, owner: s)
      XCTAssertEqual(span.count, capacity)
    }

    s.withUnsafeMutableBufferPointer {
      var span = Span(_unsafeElements: $0, owner: $0)
      XCTAssertEqual(span.count, capacity)

      let pointer: UnsafeMutablePointer = $0.baseAddress!
      span = Span(_unsafeStart: pointer, count: $0.count, owner: $0)
      XCTAssertEqual(span.count, capacity)
    }
  }
  ...
  func testInitWithBitwiseCopyableElement() {
    ...
    a.withUnsafeBufferPointer {
      var span = Span(_unsafeElements: $0, owner: a)
      XCTAssertEqual(span.count, capacity)

      span = Span(_unsafeStart: $0.baseAddress!, count: $0.count, owner: a)
      XCTAssertEqual(span.count, capacity)
    }
    ...
    a.withUnsafeBytes {
      let b = Span<UInt>(_unsafeBytes: $0, owner: $0)
      XCTAssertEqual(b.count, capacity)

      let r = Span<Int8>(_unsafeBytes: $0, owner: $0)
  ...
  func testIsEmpty() {
    ...
    a.withUnsafeBufferPointer {
      let span = Span(_unsafeElements: $0, owner: $0)
      XCTAssertFalse(span.isEmpty)

      let empty = Span(
        _unsafeElements: .init(rebasing: $0.dropFirst(capacity)), owner: $0
      )
  ...
  func testElementsEqual() {
    ...
    a.withUnsafeBufferPointer {
      ...
      copy.withUnsafeBufferPointer {
        let spanOfCopy = Span(_unsafeElements: $0, owner: $0)
  ...
  func testRangeOfIndicesSubscriptBitwiseCopyable() {
    ...
    let a = Array(0..<capacity)
    a.withUnsafeBufferPointer {
      let v = Span(_unsafeElements: $0, owner: $0)
  ...
  func testPrefix() {
    ...
    do {
      ...
      let span = Span(_unsafeElements: b, owner: b)
  ...
  func testSuffix() {
    ...
    let a = Array(0..<capacity)
    a.withUnsafeBufferPointer {
      let span = Span<Int>(_unsafeElements: $0, owner: $0)
      XCTAssertEqual(span.count, capacity)
  ...
  public func testWithUnsafeBytes() {
    ...
    a.withUnsafeBufferPointer {
      ub in
      let span = Span(_unsafeElements: ub, owner: ub)
  ...
  public func testWithUnsafeBuffer() {
    ...
    a.withUnsafeBufferPointer {
      ...
      let empty = Span(_unsafeElements: emptyBuffer, owner: ub)
  ...
  func testContainment() {
    ...
    let fakeSpan = Span(
      _unsafeStart: b.baseAddress!.advanced(by: 8), count: 8, owner: b
    )
    let nilSpan = Span<Int>(
      _unsafeElements: UnsafeBufferPointer(start: nil, count: 0), owner: b
    )
